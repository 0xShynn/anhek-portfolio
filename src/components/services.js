...
const Services = () => {
  return (
    <section id="services" className="max-w-4xl py-20 mx-auto">
      <div className="flex flex-wrap">
        <div className="w-20 m-10 hover:bg-green-300">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path
              d="M14.01 89.89L6 .05h88.09l-8.01 89.84-36.13 10.16"
              fill="#d2e1ff"
            />
            <path
              fill="#fff"
              d="M50.15 18.41H22.41l.2 2.93 2.73 30.47h38.28l-1.37 14.25-12.3 3.32-12.3-3.32-.79-8.79H25.93l1.36 17.39 22.66 6.25h.2v-.06l22.46-6.19.19-1.96 2.54-29.1.39-2.93H35.5l-.98-11.33h42.19L76.9 27l.59-5.66.19-2.93z"
            />
          </svg>
        </div>
        <div className="w-20 m-10 hover:bg-green-300">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <g id="g3013_2_" transform="translate(119 276.3622)">
              <path
                fill="#d2e1ff"
                d="M-24.87-276.31l-8.03 89.98-36.11 10.02-36.01-10-8.02-90z"
              />
              <path fill="#d2e1ff" d="M-39.78-192.06l6.87-76.9h-36.04v84.99z" />
              <path fill="#fff" d="M-94.64-235.57l.99 11.03h24.7v-11.03z" />
              <path fill="#fff" d="M-68.95-257.92h-27.68l1 11.04h26.68z" />
              <path
                fill="#fff"
                d="M-68.95-195.42v-11.49l-.05.02-12.29-3.32-.79-8.81h-11.08l1.54 17.34 22.62 6.27z"
              />
              <path
                fill="#fff"
                d="M-55.4-224.54l-1.28 14.32-12.31 3.32v11.49l22.63-6.27.16-1.87 2.6-29.06.27-2.96 1.99-22.35h-27.65v11.04h15.55l-1 11.31h-14.55v11.03z"
              />
            </g>
          </svg>
        </div>
        <div className="w-20 m-10">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path fill="#d2e1ff" d="M.05.05h100v100H.05z" />
            <path
              fill="#FFF"
              d="M26.34 83.61l7.65-4.63c1.48 2.62 2.82 4.83 6.04 4.83 3.09 0 5.03-1.21 5.03-5.91V45.96h9.4v32.09c0 9.73-5.71 14.16-14.03 14.16-7.51 0-11.87-3.9-14.09-8.6M59.57 82.61l7.65-4.43c2.01 3.29 4.63 5.71 9.26 5.71 3.89 0 6.38-1.95 6.38-4.63 0-3.22-2.55-4.36-6.85-6.24L73.67 72c-6.78-2.89-11.28-6.51-11.28-14.16 0-7.05 5.37-12.42 13.76-12.42 5.97 0 10.27 2.08 13.36 7.52l-7.32 4.7c-1.61-2.89-3.36-4.03-6.04-4.03-2.75 0-4.5 1.75-4.5 4.03 0 2.82 1.75 3.96 5.77 5.71l2.35 1.01c7.99 3.42 12.49 6.91 12.49 14.77 0 8.46-6.65 13.09-15.57 13.09-8.73-.01-14.37-4.17-17.12-9.61"
            />
          </svg>
        </div>
        <div className="w-20 m-10">
