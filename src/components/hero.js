...
const Hero = () => {
  return ( 
    <section className="flex flex-wrap mx-auto px-12 pb-20 pt-20 max-w-md sm:max-w-xl md:max-w-6xl md:py-20 lg:py-40">
      ...
      <div className="md:w-2/3 flex items-center mt-4 md:mt-0 md:pl-3">
        <div className="flex items-center flex-col text-white md:items-start">
          ...
          <h3 className="w-full text-gray-100 text-center mb-3 md:text-left text-xl sm:text-1xl md:max-w-md lg:max-w-lg">I enjoy crafting meaningful and intuitive solutions with pixels and code.</h3>
          <Social/>
        </div>
      </div>
    </section>
